...
const formatter = (skripsi, index) => {
    return {
      "id": index,
      "title": skripsi.title.value,
      "date": skripsi.date.value,
      "link": skripsi.link.value,
      "category": skripsi.category.value, 
    }
  }
  ...
  <div className="container">
    <div key={news.id}>
      <div className="col-md-10">
        <div className="judul"><a href="{news.link}}">{news.title}</a></div>
        <div class="row">
          <div class="col-md-2">
            {news.category}  
          </div>
