...
export default function Homepage() {
  ...
  return (
    ...
    <
    a href = "index.html"
    className = "logo" > < img src = "./img/logo.png"
    alt = "" / > < /a> <
    /div> {
      /* /logo */ } {
      /* nav */ } <
    ...
    href = "blog-post.html" > < img src = "./img/widget-2.jpg"
    alt = "" / > < /a> <
    ...
    <
    a className = "post-img"
    href = "blog-post.html" > < img src = "./img/widget-3.jpg"
    alt = "" / > < /a> <
    div className = "post-body" >
    <
    ...
    <
    a className = "post-img"
    href = "blog-post.html" > < img src = "./img/widget-4.jpg"
    alt = "" / > < /a> <
    div className = "post-body" >
    <
