...
export default function Homepage() {
  ...
  const getData = async (title) => {
    ...
    const queryData = {
      query: `PREFIX news:<http://example.co.id/ns/newsdata>
            ...
            FILTER contains(?category,"${title}")
    }`,
    };
  ...
  return (
    ...
    <body>
      ...
      {/* Navbar */}
      <nav className="navbar navbar-expand-lg navbar-nav navbar-light bg-light">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item">
              <h1 className="nav-link"  onClick={getData}>
                Home  
              </h1>
            </li>
            </li>
      ...
      <div className="row">
          ...
          <div className="row">
            <input
                ...
                id="search"
                value="Search"
                onClick={getData(setValue.title)}
            />
          </div>
        </form>
      </div>
